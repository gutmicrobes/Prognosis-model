#section 1 Univariate Cox analysis
library(survival)
pFilter=0.05
rt=read.table("TCGAtrainexpTime.txt",header=T,sep="\t",check.names=F,row.names=1)
outTab=data.frame()
...
#section 3 Multivariate cox analysis
library(survival)
...
#section 4 distribution and survival analysis of training dataset
library(survival)
library("survminer")
library(tidyverse)
...
#section 5 plot heatmap and survstat map
library(pheatmap)
...
#section 6 ROC curve of training dataset
rm(list=ls())
library(timeROC)
library(survival)
...
#section 7 Multivariate independent prognostic analysis of training dataset
library(survival)
